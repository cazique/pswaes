<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'estados_contacto' table.
	...
	*/
	...
	function estados_contacto_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function estados_contacto_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function estados_contacto_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['nombre'], $data['descripcion'], $data['dias_inactividad_min'], $data['dias_inactividad_max'], $data['orden'], $data['color']
	...
	*/
	...
	function estados_contacto_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function estados_contacto_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function estados_contacto_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are:
	 *     $data['estado_contacto_id'], $data['nombre'], $data['descripcion'], $data['dias_inactividad_min'], $data['dias_inactividad_max'], $data['orden'], $data['color']
	...
	*/
	...
	function estados_contacto_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function estados_contacto_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function estados_contacto_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function estados_contacto_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function estados_contacto_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function estados_contacto_batch_actions(&$args) {
