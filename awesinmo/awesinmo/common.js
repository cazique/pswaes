...
function actividades_validateData(insertMode) {
	...
	const reqFields = [
		...
		['text', 'actividad_id', 'Actividad id'],
		['text', 'asunto', 'Asunto'],
		['date', 'fecha', 'Fecha'],
	];
...
function actividades_encargos_validateData(insertMode) {
	$j('.has-error').removeClass('has-error');
	var errors = false;
...
function agencias_validateData(insertMode) {
	$j('.has-error').removeClass('has-error');
	var errors = false;
...
function clientes_validateData(insertMode) {
	$j('.has-error').removeClass('has-error');
	var errors = false;
...
function detalles_procedencia_validateData(insertMode) {
	$j('.has-error').removeClass('has-error');
	var errors = false;
	...
	const reqFields = [
		// [field-type, field-name, field-caption], ...
		['text', 'tipo_procedencia_id', 'Tipo procedencia id'],
		['text', 'nombre', 'Nombre'],
	];
...
function direcciones_validateData(insertMode) {
	$j('.has-error').removeClass('has-error');
	var errors = false;
	...
	const reqFields = [
		// [field-type, field-name, field-caption], ...
		['list', 'tipo_direccion', 'Tipo direccion'],
		['text', 'calle', 'Calle'],
...
function encargos_validateData(insertMode) {
	$j('.has-error').removeClass('has-error');
	var errors = false;
	...
	const reqFields = [
		// [field-type, field-name, field-caption], ...
		['text', 'encargo_id', 'Encargo id'],
		['text', 'inmueble_id', 'Inmueble id'],
		['text', 'propietario_id', 'Propietario id'],
		['text', 'estado_id', 'Estado id'],
		['text', 'motivo', 'Motivo'],
		['text', 'precio', 'Precio'],
	];
...
function estados_contacto_validateData(insertMode) {
	$j('.has-error').removeClass('has-error');
	var errors = false;
...
function estados_encargo_validateData(insertMode) {
	$j('.has-error').removeClass('has-error');
	var errors = false;
...
function estados_noticia_validateData(insertMode) {
	$j('.has-error').removeClass('has-error');
	var errors = false;
...
function inmuebles_validateData(insertMode) {
	$j('.has-error').removeClass('has-error');
	var errors = false;
...
function modalidades_contacto_validateData(insertMode) {
	$j('.has-error').removeClass('has-error');
	var errors = false;
...
function motivos_cierre_validateData(insertMode) {
	$j('.has-error').removeClass('has-error');
	var errors = false;
...
function noticias_validateData(insertMode) {
	$j('.has-error').removeClass('has-error');
	var errors = false;
	...
	const reqFields = [
		// [field-type, field-name, field-caption], ...
		['text', 'noticia_id', 'Noticia id'],
		['text', 'cliente_id', 'Cliente id'],
		['text', 'estado_noticia_id', 'Estado noticia id'],
		['list', 'motivacion', 'Motivacion'],
	];
...
function prioridades_validateData(insertMode) {
	$j('.has-error').removeClass('has-error');
	var errors = false;
...
function subtipologias_inmueble_validateData(insertMode) {
	$j('.has-error').removeClass('has-error');
	var errors = false;
	...
	const reqFields = [
		// [field-type, field-name, field-caption], ...
		['text', 'tipologia_id', 'Tipologia id'],
		['text', 'nombre', 'Nombre'],
	];
...
function subzonas_validateData(insertMode) {
	$j('.has-error').removeClass('has-error');
	var errors = false;
...
function tipologias_inmueble_validateData(insertMode) {
	$j('.has-error').removeClass('has-error');
	var errors = false;
...
function tipos_actividad_validateData(insertMode) {
	$j('.has-error').removeClass('has-error');
	var errors = false;
...
function tipos_procedencia_validateData(insertMode) {
	$j('.has-error').removeClass('has-error');
	var errors = false;
...
function usuarios_validateData(insertMode) {
	$j('.has-error').removeClass('has-error');
	var errors = false;
...
function zonas_validateData(insertMode) {
	$j('.has-error').removeClass('has-error');
	var errors = false;
...
AppGini.handleLightbox = () => {
	...
	$j('body').on('click', 'a[data-lightbox]', function(e) {
		...
		const modalOptions = {
			message: `
				<div id="${uniqueId}" class="carousel slide" data-ride="carousel" data-interval="" style=" 
					height: 100%; 
					display: flex; 
					align-items: center; 
		...
		if(images.length == 1) {
			modalOptions.message = `<img src="${images[0]}" class="img-responsive center-block" alt="">`;
