<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'subtipologias_inmueble' table.
	...
	*/
	...
	function subtipologias_inmueble_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function subtipologias_inmueble_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function subtipologias_inmueble_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['tipologia_id'], $data['nombre'], $data['descripcion']
	...
	*/
	...
	function subtipologias_inmueble_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function subtipologias_inmueble_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function subtipologias_inmueble_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are:
	 *     $data['subtipologia_id'], $data['tipologia_id'], $data['nombre'], $data['descripcion']
	...
	*/
	...
	function subtipologias_inmueble_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function subtipologias_inmueble_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function subtipologias_inmueble_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function subtipologias_inmueble_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function subtipologias_inmueble_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function subtipologias_inmueble_batch_actions(&$args) {
