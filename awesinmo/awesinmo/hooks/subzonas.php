<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'subzonas' table.
	...
	*/
	...
	function subzonas_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function subzonas_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function subzonas_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['zona_id'], $data['nombre'], $data['descripcion']
	...
	*/
	...
	function subzonas_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function subzonas_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function subzonas_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are:
	 *     $data['subzona_id'], $data['zona_id'], $data['nombre'], $data['descripcion']
	...
	*/
	...
	function subzonas_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function subzonas_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function subzonas_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function subzonas_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function subzonas_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function subzonas_batch_actions(&$args) {
