<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'clientes' table.
	...
	*/
	...
	function clientes_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function clientes_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function clientes_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['nombre'], $data['apellidos'], $data['nombre_completo'], $data['tratamiento'], $data['genero'], $data['fecha_nacimiento'], $data['documento_id'], $data['nacionalidad'], $data['estado_civil'], $data['telefono_fijo'], $data['telefono_movil'], $data['telefono_adicional'], $data['email'], $data['cliente_telefonico'], $data['profesion'], $data['sector_actividad'], $data['empresa'], $data['fecha_alta'], $data['ultima_modificacion'], $data['agencia_id'], $data['usuario_id'], $data['observaciones']
	...
	*/
	...
	function clientes_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function clientes_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are:
	 *     $data['cliente_id'], $data['nombre'], $data['apellidos'], $data['nombre_completo'], $data['tratamiento'], $data['genero'], $data['fecha_nacimiento'], $data['documento_id'], $data['nacionalidad'], $data['estado_civil'], $data['telefono_fijo'], $data['telefono_movil'], $data['telefono_adicional'], $data['email'], $data['cliente_telefonico'], $data['profesion'], $data['sector_actividad'], $data['empresa'], $data['fecha_alta'], $data['ultima_modificacion'], $data['agencia_id'], $data['usuario_id'], $data['observaciones']
	...
	*/
	...
	function clientes_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function clientes_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function clientes_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function clientes_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function clientes_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function clientes_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function clientes_batch_actions(&$args) {
