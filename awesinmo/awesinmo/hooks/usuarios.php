<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'usuarios' table.
	...
	*/
	 ...
	 *     $data['nombre'], $data['apellidos'], $data['nombre_completo'], $data['email'], $data['telefono'], $data['puesto'], $data['agencia_id'], $data['activo'], $data['fecha_alta'], $data['ultima_conexion']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are:
	 *     $data['usuario_id'], $data['nombre'], $data['apellidos'], $data['nombre_completo'], $data['email'], $data['telefono'], $data['puesto'], $data['agencia_id'], $data['activo'], $data['fecha_alta'], $data['ultima_conexion']
