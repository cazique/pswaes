<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'motivos_cierre' table.
	...
	*/
	...
	function motivos_cierre_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function motivos_cierre_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function motivos_cierre_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['nombre'], $data['descripcion'], $data['es_positivo']
	...
	*/
	...
	function motivos_cierre_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function motivos_cierre_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function motivos_cierre_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are:
	 *     $data['motivo_cierre_id'], $data['nombre'], $data['descripcion'], $data['es_positivo']
	...
	*/
	...
	function motivos_cierre_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function motivos_cierre_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function motivos_cierre_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function motivos_cierre_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function motivos_cierre_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function motivos_cierre_batch_actions(&$args) {
