<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'estados_encargo' table.
	...
	*/
	...
	function estados_encargo_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function estados_encargo_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function estados_encargo_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function estados_encargo_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function estados_encargo_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function estados_encargo_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are:
	 *     $data['estado_id'], $data['nombre'], $data['descripcion'], $data['orden'], $data['color']
	...
	*/
	...
	function estados_encargo_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function estados_encargo_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function estados_encargo_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function estados_encargo_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function estados_encargo_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function estados_encargo_batch_actions(&$args) {
