<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'inmuebles' table.
	...
	*/
	 ...
	 * @see https://bigprof.com/appgini/help/advanced-topics/hooks/DataList-object/
	 *
	 * @param $memberInfo
	...
	*/
	...
	function inmuebles_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function inmuebles_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function inmuebles_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['referencia'], $data['propietario_id'], $data['estado'], $data['tipologia_id'], $data['subtipologia_id'], $data['direccion_id'], $data['zona_id'], $data['dormitorios'], $data['banos'], $data['aseos'], $data['m2_utiles'], $data['m2_construidos'], $data['m2_terraza'], $data['altura'], $data['orientacion'], $data['estado_conservacion'], $data['ano_construccion'], $data['ano_reforma'], $data['ascensor'], $data['terraza'], $data['balcon'], $data['garaje'], $data['trastero'], $data['calefaccion_tipo'], $data['climatizacion'], $data['certificado_energetico'], $data['consumo_energetico'], $data['emisiones_co2'], $data['referencia_catastral'], $data['fecha_alta'], $data['ultima_modificacion'], $data['llaves_oficina'], $data['notas_privadas'], $data['observaciones']
	...
	*/
	...
	function inmuebles_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function inmuebles_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are:
	 *     $data['inmueble_id'], $data['referencia'], $data['propietario_id'], $data['estado'], $data['tipologia_id'], $data['subtipologia_id'], $data['direccion_id'], $data['zona_id'], $data['dormitorios'], $data['banos'], $data['aseos'], $data['m2_utiles'], $data['m2_construidos'], $data['m2_terraza'], $data['altura'], $data['orientacion'], $data['estado_conservacion'], $data['ano_construccion'], $data['ano_reforma'], $data['ascensor'], $data['terraza'], $data['balcon'], $data['garaje'], $data['trastero'], $data['calefaccion_tipo'], $data['climatizacion'], $data['certificado_energetico'], $data['consumo_energetico'], $data['emisiones_co2'], $data['referencia_catastral'], $data['fecha_alta'], $data['ultima_modificacion'], $data['llaves_oficina'], $data['notas_privadas'], $data['observaciones']
	...
	*/
	...
	function inmuebles_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function inmuebles_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function inmuebles_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function inmuebles_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function inmuebles_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function inmuebles_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function inmuebles_batch_actions(&$args) {
