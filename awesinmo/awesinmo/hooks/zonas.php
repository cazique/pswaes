<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'zonas' table.
	...
	*/
	...
	function zonas_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function zonas_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function zonas_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['nombre'], $data['localidad'], $data['provincia'], $data['descripcion']
	...
	*/
	...
	function zonas_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function zonas_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function zonas_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are:
	 *     $data['zona_id'], $data['nombre'], $data['localidad'], $data['provincia'], $data['descripcion']
	...
	*/
	...
	function zonas_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function zonas_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function zonas_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function zonas_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function zonas_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function zonas_batch_actions(&$args) {
