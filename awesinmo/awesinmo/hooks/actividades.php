<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'actividades' table.
	...
	*/
	...
	function actividades_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function actividades_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function actividades_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['referencia'], $data['usuario_id'], $data['cliente_id'], $data['asunto'], $data['tipo_actividad_id'], $data['modalidad_contacto_id'], $data['fecha'], $data['hora_inicio'], $data['hora_fin'], $data['duracion_minutos'], $data['prioridad_id'], $data['estado_id'], $data['descripcion'], $data['resultado'], $data['fecha_creacion'], $data['fecha_modificacion']
	...
	*/
	...
	function actividades_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function actividades_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are:
	 *     $data['actividad_id'], $data['referencia'], $data['usuario_id'], $data['cliente_id'], $data['asunto'], $data['tipo_actividad_id'], $data['modalidad_contacto_id'], $data['fecha'], $data['hora_inicio'], $data['hora_fin'], $data['duracion_minutos'], $data['prioridad_id'], $data['estado_id'], $data['descripcion'], $data['resultado'], $data['fecha_creacion'], $data['fecha_modificacion']
	...
	*/
	...
	function actividades_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function actividades_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function actividades_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function actividades_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function actividades_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function actividades_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function actividades_batch_actions(&$args) {
