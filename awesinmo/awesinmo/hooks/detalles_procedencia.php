<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'detalles_procedencia' table.
	...
	*/
	...
	function detalles_procedencia_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function detalles_procedencia_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function detalles_procedencia_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['tipo_procedencia_id'], $data['nombre'], $data['descripcion']
	...
	*/
	...
	function detalles_procedencia_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function detalles_procedencia_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function detalles_procedencia_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are:
	 *     $data['detalle_procedencia_id'], $data['tipo_procedencia_id'], $data['nombre'], $data['descripcion']
	...
	*/
	...
	function detalles_procedencia_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function detalles_procedencia_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function detalles_procedencia_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function detalles_procedencia_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function detalles_procedencia_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function detalles_procedencia_batch_actions(&$args) {
