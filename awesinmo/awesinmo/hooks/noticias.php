<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'noticias' table.
	...
	*/
	...
	function noticias_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function noticias_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function noticias_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['referencia'], $data['inmueble_id'], $data['cliente_id'], $data['colaborador_id'], $data['estado_noticia_id'], $data['estado_contacto_id'], $data['tipo_procedencia_id'], $data['detalle_procedencia_id'], $data['motivacion'], $data['valoracion'], $data['valoracion_solo_inmueble'], $data['precio_pedido'], $data['fecha_valoracion'], $data['fecha_estimacion_interna'], $data['fecha_ultima_cita'], $data['fecha_ultimo_contacto'], $data['fecha_cierre'], $data['motivo_cierre_id'], $data['nota'], $data['fecha_creacion'], $data['fecha_modificacion']
	...
	*/
	...
	function noticias_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function noticias_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are:
	 *     $data['noticia_id'], $data['referencia'], $data['inmueble_id'], $data['cliente_id'], $data['colaborador_id'], $data['estado_noticia_id'], $data['estado_contacto_id'], $data['tipo_procedencia_id'], $data['detalle_procedencia_id'], $data['motivacion'], $data['valoracion'], $data['valoracion_solo_inmueble'], $data['precio_pedido'], $data['fecha_valoracion'], $data['fecha_estimacion_interna'], $data['fecha_ultima_cita'], $data['fecha_ultimo_contacto'], $data['fecha_cierre'], $data['motivo_cierre_id'], $data['nota'], $data['fecha_creacion'], $data['fecha_modificacion']
	...
	*/
	...
	function noticias_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function noticias_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function noticias_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function noticias_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function noticias_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function noticias_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function noticias_batch_actions(&$args) {
