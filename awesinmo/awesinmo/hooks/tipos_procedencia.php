<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'tipos_procedencia' table.
	...
	*/
	...
	function tipos_procedencia_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function tipos_procedencia_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function tipos_procedencia_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function tipos_procedencia_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipos_procedencia_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function tipos_procedencia_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipos_procedencia_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function tipos_procedencia_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function tipos_procedencia_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function tipos_procedencia_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function tipos_procedencia_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function tipos_procedencia_batch_actions(&$args) {
