<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'prioridades' table.
	...
	*/
	...
	function prioridades_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function prioridades_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function prioridades_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function prioridades_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function prioridades_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function prioridades_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are:
	 *     $data['prioridad_id'], $data['nombre'], $data['descripcion'], $data['orden'], $data['color']
	...
	*/
	...
	function prioridades_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function prioridades_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function prioridades_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function prioridades_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function prioridades_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function prioridades_batch_actions(&$args) {
