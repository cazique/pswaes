<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'agencias' table.
	...
	*/
	...
	function agencias_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function agencias_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function agencias_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['nombre'], $data['direccion'], $data['codigo_postal'], $data['localidad'], $data['provincia'], $data['telefono'], $data['email'], $data['responsable_id'], $data['fecha_alta'], $data['activo']
	...
	*/
	...
	function agencias_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function agencias_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are:
	 *     $data['agencia_id'], $data['nombre'], $data['direccion'], $data['codigo_postal'], $data['localidad'], $data['provincia'], $data['telefono'], $data['email'], $data['responsable_id'], $data['fecha_alta'], $data['activo']
	...
	*/
	...
	function agencias_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function agencias_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function agencias_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function agencias_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function agencias_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function agencias_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function agencias_batch_actions(&$args) {
