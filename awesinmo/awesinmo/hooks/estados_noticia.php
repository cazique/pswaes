<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'estados_noticia' table.
	...
	*/
	...
	function estados_noticia_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function estados_noticia_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function estados_noticia_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['nombre'], $data['descripcion'], $data['orden'], $data['color']
	...
	*/
	...
	function estados_noticia_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function estados_noticia_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function estados_noticia_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are:
	 *     $data['estado_noticia_id'], $data['nombre'], $data['descripcion'], $data['orden'], $data['color']
	...
	*/
	...
	function estados_noticia_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function estados_noticia_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function estados_noticia_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function estados_noticia_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function estados_noticia_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function estados_noticia_batch_actions(&$args) {
