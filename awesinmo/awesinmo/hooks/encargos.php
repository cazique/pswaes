<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'encargos' table.
	...
	*/
	...
	function encargos_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function encargos_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function encargos_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['referencia'], $data['inmueble_id'], $data['propietario_id'], $data['estado_id'], $data['estado_contacto_id'], $data['motivo'], $data['tipo_procedencia_id'], $data['precio'], $data['precio_parking_incluido'], $data['valoracion'], $data['valoracion_solo_inmueble'], $data['nuda_propiedad'], $data['tratabilidad'], $data['fecha_creacion'], $data['fecha_modificacion'], $data['fecha_cierre'], $data['motivo_cierre_id'], $data['fecha_ultima_cita'], $data['fecha_ultima_actividad'], $data['fecha_ultimo_contacto'], $data['nota_privada'], $data['llaves_oficina']
	...
	*/
	...
	function encargos_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function encargos_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are:
	 *     $data['encargo_id'], $data['referencia'], $data['inmueble_id'], $data['propietario_id'], $data['estado_id'], $data['estado_contacto_id'], $data['motivo'], $data['tipo_procedencia_id'], $data['precio'], $data['precio_parking_incluido'], $data['valoracion'], $data['valoracion_solo_inmueble'], $data['nuda_propiedad'], $data['tratabilidad'], $data['fecha_creacion'], $data['fecha_modificacion'], $data['fecha_cierre'], $data['motivo_cierre_id'], $data['fecha_ultima_cita'], $data['fecha_ultima_actividad'], $data['fecha_ultimo_contacto'], $data['nota_privada'], $data['llaves_oficina']
	...
	*/
	...
	function encargos_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function encargos_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function encargos_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function encargos_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function encargos_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function encargos_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function encargos_batch_actions(&$args) {
