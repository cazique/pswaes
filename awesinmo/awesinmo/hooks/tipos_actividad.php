<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'tipos_actividad' table.
	...
	*/
	...
	function tipos_actividad_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function tipos_actividad_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function tipos_actividad_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['nombre'], $data['descripcion'], $data['requiere_resultado']
	...
	*/
	...
	function tipos_actividad_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipos_actividad_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function tipos_actividad_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are:
	 *     $data['tipo_actividad_id'], $data['nombre'], $data['descripcion'], $data['requiere_resultado']
	...
	*/
	...
	function tipos_actividad_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function tipos_actividad_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function tipos_actividad_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function tipos_actividad_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function tipos_actividad_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function tipos_actividad_batch_actions(&$args) {
