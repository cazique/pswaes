<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'actividades_encargos' table.
	...
	*/
	...
	function actividades_encargos_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function actividades_encargos_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function actividades_encargos_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function actividades_encargos_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function actividades_encargos_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are:
	 *     $data['actividad_id'], $data['encargo_id']
	...
	*/
	...
	function actividades_encargos_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function actividades_encargos_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function actividades_encargos_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function actividades_encargos_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function actividades_encargos_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function actividades_encargos_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function actividades_encargos_batch_actions(&$args) {
