<?php
	...
	*/
	...
	function get_tables_info($skip_authentication = false) {
		...
		$all_tables = [
			/* ['table_name' => [table props assoc array] */   
				'actividades' => [
					'Caption' => 'Actividades',
					'Description' => 'Table imported using MySQL2AppGini on 2025-05-01',
					'tableIcon' => 'table.gif',
					'group' => $tg[0],
					'homepageShowCount' => 0
				],
				'actividades_encargos' => [
					'Caption' => 'Actividades encargos',
					'Description' => 'Table imported using MySQL2AppGini on 2025-05-01',
					'tableIcon' => 'table.gif',
					'group' => $tg[0],
					'homepageShowCount' => 0
				...
				'subtipologias_inmueble' => [
					'Caption' => 'Subtipologias inmueble',
					'Description' => 'Table imported using MySQL2AppGini on 2025-05-01',
					'tableIcon' => 'table.gif',
					'group' => $tg[0],
					'homepageShowCount' => 0
	...
	function getTableList($skip_authentication = false, $include_internal_tables = false) {
		...
		$arrTables = [
			...
			'actividades' => ['Actividades', 'Table imported using MySQL2AppGini on 2025-05-01', 'table.gif', 'None'],
			'actividades_encargos' => ['Actividades encargos', 'Table imported using MySQL2AppGini on 2025-05-01', 'table.gif', 'None'],
			'agencias' => ['Agencias', 'Table imported using MySQL2AppGini on 2025-05-01', 'table.gif', 'None'],
			'clientes' => ['Clientes', 'Table imported using MySQL2AppGini on 2025-05-01', 'table.gif', 'None'],
			'detalles_procedencia' => ['Detalles procedencia', 'Table imported using MySQL2AppGini on 2025-05-01', 'table.gif', 'None'],
			'direcciones' => ['Direcciones', 'Table imported using MySQL2AppGini on 2025-05-01', 'table.gif', 'None'],
			'encargos' => ['Encargos', 'Table imported using MySQL2AppGini on 2025-05-01', 'table.gif', 'None'],
			'estados_contacto' => ['Estados contacto', 'Table imported using MySQL2AppGini on 2025-05-01', 'table.gif', 'None'],
			'estados_encargo' => ['Estados encargo', 'Table imported using MySQL2AppGini on 2025-05-01', 'table.gif', 'None'],
			'estados_noticia' => ['Estados noticia', 'Table imported using MySQL2AppGini on 2025-05-01', 'table.gif', 'None'],
			'inmuebles' => ['Inmuebles', 'Table imported using MySQL2AppGini on 2025-05-01', 'table.gif', 'None'],
			'modalidades_contacto' => ['Modalidades contacto', 'Table imported using MySQL2AppGini on 2025-05-01', 'table.gif', 'None'],
			'motivos_cierre' => ['Motivos cierre', 'Table imported using MySQL2AppGini on 2025-05-01', 'table.gif', 'None'],
			'noticias' => ['Noticias', 'Table imported using MySQL2AppGini on 2025-05-01', 'table.gif', 'None'],
			'prioridades' => ['Prioridades', 'Table imported using MySQL2AppGini on 2025-05-01', 'table.gif', 'None'],
			'subtipologias_inmueble' => ['Subtipologias inmueble', 'Table imported using MySQL2AppGini on 2025-05-01', 'table.gif', 'None'],
			'subzonas' => ['Subzonas', 'Table imported using MySQL2AppGini on 2025-05-01', 'table.gif', 'None'],
			'tipologias_inmueble' => ['Tipologias inmueble', 'Table imported using MySQL2AppGini on 2025-05-01', 'table.gif', 'None'],
			'tipos_actividad' => ['Tipos actividad', 'Table imported using MySQL2AppGini on 2025-05-01', 'table.gif', 'None'],
			'tipos_procedencia' => ['Tipos procedencia', 'Table imported using MySQL2AppGini on 2025-05-01', 'table.gif', 'None'],
			'usuarios' => ['Usuarios', 'Table imported using MySQL2AppGini on 2025-05-01', 'table.gif', 'None'],
			'zonas' => ['Zonas', 'Table imported using MySQL2AppGini on 2025-05-01', 'table.gif', 'None'],
		];
		...
		if($schema === null) {
			...
			$schema = [
				...
				'agencias' => [
					...
					'activo' => [
						'appgini' => "TINYINT(1) NULL DEFAULT '1'",
						'info' => [
							'caption' => 'Activo',
							'description' => '',
						],
				...
				'clientes' => [
					...
					'cliente_telefonico' => [
						'appgini' => "TINYINT(1) NULL DEFAULT '0'",
						'info' => [
							'caption' => 'Cliente telefonico',
							'description' => '',
						],
					],
					'profesion' => [
				...
				'detalles_procedencia' => [
					'detalle_procedencia_id' => [
						...
						'info' => [
							'caption' => 'Detalle procedencia id',
							'description' => '',
						],
					],
					'tipo_procedencia_id' => [
				...
				'direcciones' => [
					...
					'pais' => [
						'appgini' => "VARCHAR(50) NULL DEFAULT 'Espana'",
						'info' => [
							'caption' => 'Pais',
							'description' => '',
						],
					...
					'coordenadas_latitud' => [
						'appgini' => "DECIMAL(10,8) NULL",
						'info' => [
							'caption' => 'Coordenadas latitud',
							'description' => '',
						],
					],
					'coordenadas_longitud' => [
						'appgini' => "DECIMAL(11,8) NULL",
						'info' => [
							'caption' => 'Coordenadas longitud',
							'description' => '',
						],
					],
					'principal' => [
				...
				'encargos' => [
					...
					'precio' => [
						'appgini' => "DECIMAL(12,2) NOT NULL",
						'info' => [
							'caption' => 'Precio',
							'description' => '',
						],
					],
					'precio_parking_incluido' => [
						'appgini' => "TINYINT(1) NULL DEFAULT '0'",
						'info' => [
							'caption' => 'Precio parking incluido',
							'description' => '',
						],
					],
					'valoracion' => [
						'appgini' => "DECIMAL(12,2) NULL",
						'info' => [
							'caption' => 'Valoracion',
							'description' => '',
						],
					...
					'valoracion_solo_inmueble' => [
						'appgini' => "DECIMAL(12,2) NULL",
						'info' => [
							'caption' => 'Valoracion solo inmueble',
							'description' => '',
						],
					],
					'nuda_propiedad' => [
						'appgini' => "TINYINT(1) NULL DEFAULT '0'",
						'info' => [
							'caption' => 'Nuda propiedad',
							'description' => '',
						],
					],
					'tratabilidad' => [
						'appgini' => "TINYINT(4) NULL",
						'info' => [
							'caption' => 'Tratabilidad',
							'description' => '',
						],
					],
					'fecha_creacion' => [
					...
					'fecha_ultima_actividad' => [
						'appgini' => "DATE NULL",
						'info' => [
							'caption' => 'Fecha ultima actividad',
							'description' => '',
						],
					],
				...
				'estados_contacto' => [
					...
					'nombre' => [
						'appgini' => "VARCHAR(50) NOT NULL UNIQUE",
						'info' => [
							'caption' => 'Nombre',
							'description' => '',
						],
					...
					'dias_inactividad_min' => [
						...
						'info' => [
							'caption' => 'Dias inactividad min',
							'description' => '',
						],
					],
					'dias_inactividad_max' => [
						'appgini' => "INT(11) NULL DEFAULT '999'",
						'info' => [
							'caption' => 'Dias inactividad max',
							'description' => '',
						],
					],
					'orden' => [
						'appgini' => "TINYINT(4) NULL DEFAULT '0'",
						'info' => [
							'caption' => 'Orden',
							'description' => '',
						],
					...
					'color' => [
						'appgini' => "VARCHAR(7) NULL DEFAULT '#000000'",
						'info' => [
							'caption' => 'Color',
							'description' => '',
						],
				...
				'inmuebles' => [
					...
					'estado' => [
						'appgini' => "VARCHAR(40) NULL DEFAULT 'Disponible'",
						'info' => [
							'caption' => 'Estado',
							'description' => '',
						],
					...
					'ano_construccion' => [
						'appgini' => "SMALLINT(6) NULL",
						'info' => [
							'caption' => 'Ano construccion',
							'description' => '',
						],
					],
					'ano_reforma' => [
					...
					'certificado_energetico' => [
						...
						'info' => [
							'caption' => 'Certificado energetico',
							'description' => '',
						],
					],
					'consumo_energetico' => [
				...
				'noticias' => [
					...
					'fecha_estimacion_interna' => [
						'appgini' => "DATE NULL",
						'info' => [
							'caption' => 'Fecha estimacion interna',
							'description' => '',
						],
					],
					'fecha_ultima_cita' => [
				...
				'usuarios' => [
					...
					'email' => [
						'appgini' => "VARCHAR(100) NULL UNIQUE",
						'info' => [
							'caption' => 'Email',
							'description' => '',
						],
	...
	*/
	...
	function getUserTheme() {
		if(NO_THEME_SELECTION) return DEFAULT_THEME;
	...
	function getUserThemeCompact() {
		if(NO_THEME_SELECTION) return THEME_COMPACT ? 'theme-compact' : '';
