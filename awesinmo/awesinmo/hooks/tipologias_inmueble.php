<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'tipologias_inmueble' table.
	...
	*/
	...
	function tipologias_inmueble_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function tipologias_inmueble_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function tipologias_inmueble_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function tipologias_inmueble_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipologias_inmueble_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function tipologias_inmueble_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function tipologias_inmueble_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function tipologias_inmueble_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function tipologias_inmueble_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function tipologias_inmueble_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function tipologias_inmueble_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function tipologias_inmueble_batch_actions(&$args) {
