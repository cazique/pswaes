AppGiniPlugin.language.en = $j.extend(AppGiniPlugin.language.en, {
	...
	group_permissions_for: 'Messaging permissions for %group% group',
	group_permissions: 'Messaging permissions',
	...
	// Added in 1.5
	preview: 'Preview',
	show_table_menus: 'Show tables navigation in inbox page',
