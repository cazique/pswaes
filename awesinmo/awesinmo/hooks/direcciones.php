<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'direcciones' table.
	...
	*/
	...
	function direcciones_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function direcciones_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function direcciones_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['cliente_id'], $data['inmueble_id'], $data['tipo_direccion'], $data['calle'], $data['numero'], $data['piso'], $data['puerta'], $data['escalera'], $data['codigo_postal'], $data['localidad'], $data['provincia'], $data['pais'], $data['referencia_catastral'], $data['coordenadas_latitud'], $data['coordenadas_longitud'], $data['principal'], $data['fecha_alta'], $data['ultima_modificacion']
	...
	*/
	...
	function direcciones_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function direcciones_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function direcciones_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are:
	 *     $data['direccion_id'], $data['cliente_id'], $data['inmueble_id'], $data['tipo_direccion'], $data['calle'], $data['numero'], $data['piso'], $data['puerta'], $data['escalera'], $data['codigo_postal'], $data['localidad'], $data['provincia'], $data['pais'], $data['referencia_catastral'], $data['coordenadas_latitud'], $data['coordenadas_longitud'], $data['principal'], $data['fecha_alta'], $data['ultima_modificacion']
	...
	*/
	...
	function direcciones_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function direcciones_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function direcciones_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function direcciones_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function direcciones_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function direcciones_batch_actions(&$args) {
