<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'modalidades_contacto' table.
	...
	*/
	...
	function modalidades_contacto_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function modalidades_contacto_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function modalidades_contacto_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function modalidades_contacto_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function modalidades_contacto_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function modalidades_contacto_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are:
	 *     $data['modalidad_contacto_id'], $data['nombre'], $data['descripcion']
	...
	*/
	...
	function modalidades_contacto_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function modalidades_contacto_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function modalidades_contacto_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function modalidades_contacto_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function modalidades_contacto_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function modalidades_contacto_batch_actions(&$args) {
